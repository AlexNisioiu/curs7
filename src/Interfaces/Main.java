...
public class Main {
 ...
 /*     KFC kfc = new KFC();
        ...
        kfc.resetMonth();
        System.out.println(kfc.getDeliveredQuantity());
        System.out.println("1. No of employees " + kfc.getNumberOfEmployees());
        kfc.hire("Ana");
        System.out.println("2. No of employees " + kfc.getNumberOfEmployees());

        Company c = kfc;
        c.hire("Alex");
        System.out.println("3. No of employees " + c.getNumberOfEmployees());
        System.out.println("4. No of employees " + kfc.getNumberOfEmployees());
...
*/
        ...
        myHouse.orderFood();
        myHouse.changeFavoriteRestaurant(new McDonalds());
        // change of mind
        myHouse.orderFood();      */
